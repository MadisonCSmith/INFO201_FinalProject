     ...
     tabPanel("Overview",
              ...
              h4("- Hannah, Justin, Mady, and Zale")
                 ...
                 tabPanel("Change in Frequency",
                          h2(" Have terrorist attacks increased in frequency
                             over the past forty-some years?"),
                          ...
                          sidebarLayout(
                            ...
                            sidebarPanel(
                              ...
                              radioButtons("unit", "Group attacks by
                                           unit of time:",
                                           c("year" = "iyear",
                                             "month" = "imonth",
                                             "day" = "iday")),
       ...
       tabPanel("Types Of Attacks",
                # Creates a title.
                h2("What types of attacks are most frequent?"),
                ...
                sidebarLayout(
                  ...
                  sidebarPanel(
                    ...
                    p("To see how the data can change, use the widgets below
                      to alter the years and location of terrorist attacks."),
                  ...
                  tabPanel("Country Comparison",
                     # Creates a title.
                     h2("What countries are most prone to terrorism over
                        time?"),
                     sidebarLayout(
                      ...
                      sidebarPanel(
                          ...
                          selectInput("countries",
                            ...
                            my.data[, "country_txt"],
                            multiple = TRUE,
                            selected = c("United States", "Spain", "Uruguay",
                                         "Argentina", "Russia", "Iraq"))
                      ),
                  ...
                  tabPanel("United States Comparison",
                    # Creates a title.
                    h2("How does the prevalence of terrorism in the U.S.
                       compare to other countries?"),
                    sidebarLayout(
                      sidebarPanel(
                        selectInput('country', "Select the country you would
                                    like to compare to",
                      ...
                      mainPanel(
                        br(),
                        p("The bar plot below will answer the question above
                           depending on the country and year that is picked.
                           The bar graph will always show the United States
                           data however, the compared country will change."),
                        plotOutput("bar"),
                        br(),
                        p("As you can see, the data is always change according
                          to the year and country. It is interesting to see
                          the frequency of terrorist attack across country
                          and year compared to the United States. There are
                          trends of terrorist attack depending on year and
                          country that reflect the state of country.")
                      )
                    )
                 )
)
